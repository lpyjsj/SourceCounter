        ...
        m_pFileExt(0)
{
    ...
    BoxSizer3->Add(m_txtExtName, 4, wxTOP|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    BoxSizer4->Add(m_txtExtDesc, 4, wxTOP|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ...
    BoxSizer6->Add(m_cmbMethod, 4, wxTOP|wxLEFT|wxRIGHT|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
void CounterRuleDlg::updateRuleCtrls()
{
    ...
    m_txtSlgLnComm->SetValue(pRule->m_strSlgLnComm);
